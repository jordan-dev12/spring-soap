...
public class PartecipanteVm {
	...
	public String toString() {
		return "PartecipanteVm [nome=" + nome + ", cognome=" + cognome + ", email=" + email + ", luogoNascita="
				+ luogoNascita + ", luogoDiResidenza=" + luogoDiResidenza + ", codiceFisacale=" + codiceFisacale
				+ ", dataNascita=" + dataNascita + ", ruoli=" + ruoli + "]";
	}
